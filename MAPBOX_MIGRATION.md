# 🗺️ Migrated from Google Maps to Mapbox
...
- ✅ `mapbox-gl` package
- ✅ Mapbox token (free tier: 50,000 loads/month)
...
- **Modern API**: React-friendly components
- **Customizable**: Easy to style and customize
- **Open Source**: More developer-friendly

### Features Maintained
- ✅ 30 world cities with markers
